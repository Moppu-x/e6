...
public class DoctorDao {
    ...
    //updateDoctor()修改数据;
    public static void updateDoctor(int id,int dept_id) {
        //根据id修改dept_id;
        try {
            //定义修改数据的sql语句;
    ...
    public static void updateDoctor(int id,String password) {
        //根据id修改password;
        try {
            //定义修改数据的sql语句;
    ...
    private static List<Doctor> execute(String sql) throws SQLException {
